...
#enum to keep memory of state of enumenation class
...
class QuizParser(xml.sax.ContentHandler):
    """
    The quizparser class loads a particular quiz file , parses it
    and returns a fully built object that can presented to the user

    """
    def __init__(self) -> None:
        self.new_quiz=Quiz()

        #TODO: properties for the parser state and current questions  and  answers
...
if __name__ == "__main__":
    app = QuizParser()
    qz = app.parse_quiz("E:/quiz\Start/Basics/03/Quizzes/SampleQuiz.xml")
    print(qz.name)
